...
const antigravityRoot = join(output, "antigravity");
await mkdir(join(codexRoot, "plugins"), { recursive: true });
await mkdir(join(claudeRoot, "plugins"), { recursive: true });
await mkdir(join(antigravityRoot, "plugins"), { recursive: true });
...
await cp(join(root, "integrations", "antigravity"), join(antigravityRoot, "plugins", "semantic-ir"), { recursive: true, force: true });
